...
import { IChannels, IGroupInfo } from "."
import { IconRenderer } from "../icon-renderer"
import IconDropDown from "./icon-dropdown"
import { v4 } from "uuid"

type MutateFunction<T> = (data: {
  id: string;
  name: string;
  icon: string;
  createdAt: Date;
...
type Props = {
  ...
  mutate: MutateFunction<{
    status: number;
    channel: { id: string; name: string; icon: string; createdAt: Date; groupId: string | null; }[];
    message?: string;
  }>; 
  sidebarIsPending: boolean
}
