...
export const usePayments = (
  ...
  const { mutateAsync: createGroup, isPending } = useMutation({
    mutationFn: async (data: z.infer<typeof CreateGroupSchema>) => {
      ...
      // take Card of registered user -- for affilation method later
      ...
      // if user get refered -- pass the comission to referal
  ...
  const onCreateGroup = handleSubmit(async (values) => {
    //  console.log("LKLKLKLKLK", values)
